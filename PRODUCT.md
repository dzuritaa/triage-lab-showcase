...
- The recorded result comes from one real Claude Haiku 4.5 call: 1,126 input /
  243 output tokens, $0.0023.
...
- `fixtures/example.json` — a real recorded triage result for EVAL-02, the
  hardest case in the set. Correct category and priority.
